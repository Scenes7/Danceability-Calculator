...
# FFF {'name': 'file', 'stream': <tempfile.SpooledTemporaryFile object at 0x0000021A07B88730>, 'filename': 'Fallen Down.wav', 'headers': Headers([('Content-Disposition', 'form-data; name="file"; filename="Fallen Down.wav"'), ('Content-Type', 'audio/wav')])}
# GGG <FileStorage: 'Fallen Down.wav' ('audio/wav')>

#         print("FFF", file.__dict__)
#         print("GGG", file)
